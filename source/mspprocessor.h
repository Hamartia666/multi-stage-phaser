...
//------------------------------------------------------------------------
class MultiStagePhaserProcessor : public Steinberg::Vst::AudioEffect
{
public:
	MultiStagePhaserProcessor ();
	~MultiStagePhaserProcessor () SMTG_OVERRIDE;

    // Create function
	static Steinberg::FUnknown* createInstance (void* /*context*/) 
	{ 
		return (Steinberg::Vst::IAudioProcessor*)new MultiStagePhaserProcessor; 
	}
